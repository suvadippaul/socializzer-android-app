package com.example.suvadip.socializzer;
...
public class LogInMainActivity extends FragmentActivity {
    ...
    public static void showHashKey(Context context) {
        try {
            PackageInfo info = context.getPackageManager().getPackageInfo(
                    "com.example.suvadip.socializzer", PackageManager.GET_SIGNATURES); //Your package name here
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        showHashKey(this.getApplicationContext());
